...
export default function ExcelToPdf() {
  const handleConvert = async (files) => {
    ...
    const response = await fetch("http://localhost:5000/api/pdf/excel-to-pdf", {
      method: "POST",
      body: formData,
    });
  ...
  return (
    <ToolLayout
      ...
      steps={[
        { num: "1", title: "Upload", desc: "Select or drag & drop your Excel file." },
      ...
      features={[
        "Preserves exact spreadsheet formatting",
